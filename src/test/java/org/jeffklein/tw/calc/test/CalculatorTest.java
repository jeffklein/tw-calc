...
public class CalculatorTest /*extends AbstractTestNGSpringContextTests*/ {
    ...
    private Player createPlayer() {
        ...
        inventory.setQuantityForType(InventoryItem.GARROTE, 620);
        inventory.setQuantityForType(InventoryItem.RIOT_SHIELD, 895);
        inventory.setQuantityForType(InventoryItem.BRASS_KNUCKLES, 935);
        inventory.setQuantityForType(InventoryItem.GERMAN_STILLETTO_KNIFE, 650);
        inventory.setQuantityForType(InventoryItem.POTATO_MASHER, 535);
        inventory.setQuantityForType(InventoryItem.SAWED_OFF_SHOTGUN, 755);
        inventory.setQuantityForType(InventoryItem.GLOCK_31, 1000);
        inventory.setQuantityForType(InventoryItem.SLUGGER, 665);
        inventory.setQuantityForType(InventoryItem.STEEL_TOED_SHOES, 68025);
        inventory.setQuantityForType(InventoryItem.BODY_ARMOR, 69540);
        inventory.setQuantityForType(InventoryItem.LUPARA, 465);
        inventory.setQuantityForType(InventoryItem.MACHETE, 535);
        inventory.setQuantityForType(InventoryItem.TOMMY_GUN, 62855);
        inventory.setQuantityForType(InventoryItem.CHAINSAW, 975);
        inventory.setQuantityForType(InventoryItem.THREE_THIRTY_EIGHT_LAPUA_RIFLE, 63545);
        inventory.setQuantityForType(InventoryItem.KEVLAR_LINED_SUIT, 660);
        inventory.setQuantityForType(InventoryItem.AR15_ASSAULT_RIFLE, 675);
        inventory.setQuantityForType(InventoryItem.BERETTA_MODELO_38A, 380);
        inventory.setQuantityForType(InventoryItem.BAZOOKA, 480);
