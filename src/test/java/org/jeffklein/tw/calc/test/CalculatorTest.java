...
public class CalculatorTest /*extends AbstractTestNGSpringContextTests*/ {
    ...
    private Player createPlayer() {
        ...
        inventory.setQuantityForType(InventoryItem.GARROTE, 605);
        inventory.setQuantityForType(InventoryItem.RIOT_SHIELD, 880);
        inventory.setQuantityForType(InventoryItem.BRASS_KNUCKLES, 930);
        inventory.setQuantityForType(InventoryItem.GERMAN_STILLETTO_KNIFE, 640);
        inventory.setQuantityForType(InventoryItem.POTATO_MASHER, 520);
        inventory.setQuantityForType(InventoryItem.SAWED_OFF_SHOTGUN, 745);
        inventory.setQuantityForType(InventoryItem.GLOCK_31, 990);
        inventory.setQuantityForType(InventoryItem.SLUGGER, 665);
        inventory.setQuantityForType(InventoryItem.STEEL_TOED_SHOES, 67250);
        inventory.setQuantityForType(InventoryItem.BODY_ARMOR, 68750);
        inventory.setQuantityForType(InventoryItem.LUPARA, 455);
        inventory.setQuantityForType(InventoryItem.MACHETE, 530);
        inventory.setQuantityForType(InventoryItem.TOMMY_GUN, 62080);
        inventory.setQuantityForType(InventoryItem.CHAINSAW, 955);
        inventory.setQuantityForType(InventoryItem.THREE_THIRTY_EIGHT_LAPUA_RIFLE, 62765);
        inventory.setQuantityForType(InventoryItem.KEVLAR_LINED_SUIT, 650);
        inventory.setQuantityForType(InventoryItem.AR15_ASSAULT_RIFLE, 670);
        inventory.setQuantityForType(InventoryItem.BERETTA_MODELO_38A, 370);
        inventory.setQuantityForType(InventoryItem.BAZOOKA, 470);
