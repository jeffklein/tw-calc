...
public class CalculatorTest /*extends AbstractTestNGSpringContextTests*/ {
    ...
    private Player createPlayer() {
        ...
        inventory.setQuantityForType(InventoryItem.GLOCK_31, 1145);
        inventory.setQuantityForType(InventoryItem.SLUGGER, 1140);
        inventory.setQuantityForType(InventoryItem.STEEL_TOED_SHOES, 71840);
        inventory.setQuantityForType(InventoryItem.BODY_ARMOR, 73915);
        inventory.setQuantityForType(InventoryItem.LUPARA, 595);
        inventory.setQuantityForType(InventoryItem.MACHETE, 935);
        inventory.setQuantityForType(InventoryItem.TOMMY_GUN, 57675);
        inventory.setQuantityForType(InventoryItem.CHAINSAW, 1085);
        inventory.setQuantityForType(InventoryItem.THREE_THIRTY_EIGHT_LAPUA_RIFLE, 59145);
        inventory.setQuantityForType(InventoryItem.KEVLAR_LINED_SUIT, 1085);
        inventory.setQuantityForType(InventoryItem.AR15_ASSAULT_RIFLE, 1150);
        inventory.setQuantityForType(InventoryItem.BERETTA_MODELO_38A, 700);
