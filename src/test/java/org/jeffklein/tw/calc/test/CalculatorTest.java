...
public class CalculatorTest /*extends AbstractTestNGSpringContextTests*/ {
    ...
    private Player createPlayer() {
        ...
        inventory.setQuantityForType(InventoryItem.GARROTE, 770);
        inventory.setQuantityForType(InventoryItem.RIOT_SHIELD, 995);
        ...
        inventory.setQuantityForType(InventoryItem.SLUGGER, 1155);
        inventory.setQuantityForType(InventoryItem.STEEL_TOED_SHOES, 72275);
        inventory.setQuantityForType(InventoryItem.BODY_ARMOR, 74390);
        inventory.setQuantityForType(InventoryItem.LUPARA, 610);
        inventory.setQuantityForType(InventoryItem.MACHETE, 955);
        inventory.setQuantityForType(InventoryItem.TOMMY_GUN, 58150);
        inventory.setQuantityForType(InventoryItem.CHAINSAW, 1115);
        inventory.setQuantityForType(InventoryItem.THREE_THIRTY_EIGHT_LAPUA_RIFLE, 59625);
        ...
        inventory.setQuantityForType(InventoryItem.BERETTA_MODELO_38A, 705);
