...
public class CalculatorTest /*extends AbstractTestNGSpringContextTests*/ {
    ...
    private Player createPlayer() {
        ...
        inventory.setQuantityForType(InventoryItem.RIOT_SHIELD, 840);
        ...
        inventory.setQuantityForType(InventoryItem.POTATO_MASHER, 490);
        inventory.setQuantityForType(InventoryItem.SAWED_OFF_SHOTGUN, 730);
        inventory.setQuantityForType(InventoryItem.GLOCK_31, 960);
        inventory.setQuantityForType(InventoryItem.SLUGGER, 650);
        inventory.setQuantityForType(InventoryItem.STEEL_TOED_SHOES, 65650);
        inventory.setQuantityForType(InventoryItem.BODY_ARMOR, 67105);
        inventory.setQuantityForType(InventoryItem.LUPARA, 420);
        inventory.setQuantityForType(InventoryItem.MACHETE, 520);
        inventory.setQuantityForType(InventoryItem.TOMMY_GUN, 60465);
        inventory.setQuantityForType(InventoryItem.CHAINSAW, 930);
        inventory.setQuantityForType(InventoryItem.THREE_THIRTY_EIGHT_LAPUA_RIFLE, 61150);
        inventory.setQuantityForType(InventoryItem.KEVLAR_LINED_SUIT, 645);
        ...
        inventory.setQuantityForType(InventoryItem.BAZOOKA, 445);
