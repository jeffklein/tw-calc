...
public class CalculatorTest /*extends AbstractTestNGSpringContextTests*/ {
    ...
    private Player createPlayer() {
        ...
        inventory.setQuantityForType(InventoryItem.RIOT_SHIELD, 1050);
        inventory.setQuantityForType(InventoryItem.MOLOTOV_COCKTAIL, 5);
        inventory.setQuantityForType(InventoryItem.BRASS_KNUCKLES, 1145);
        ...
        inventory.setQuantityForType(InventoryItem.GERMAN_STILLETTO_KNIFE, 1035);
        inventory.setQuantityForType(InventoryItem.POTATO_MASHER, 710);
        inventory.setQuantityForType(InventoryItem.SAWED_OFF_SHOTGUN, 1125);
        inventory.setQuantityForType(InventoryItem.GLOCK_31, 1205);
        inventory.setQuantityForType(InventoryItem.SLUGGER, 1230);
        inventory.setQuantityForType(InventoryItem.STEEL_TOED_SHOES, 75120);
        inventory.setQuantityForType(InventoryItem.BODY_ARMOR, 77355);
        inventory.setQuantityForType(InventoryItem.LUPARA, 685);
        inventory.setQuantityForType(InventoryItem.MACHETE, 980);
        inventory.setQuantityForType(InventoryItem.TOMMY_GUN, 59910);
        inventory.setQuantityForType(InventoryItem.CHAINSAW, 1170);
        inventory.setQuantityForType(InventoryItem.THREE_THIRTY_EIGHT_LAPUA_RIFLE, 61475);
        inventory.setQuantityForType(InventoryItem.KEVLAR_LINED_SUIT, 1145);
        inventory.setQuantityForType(InventoryItem.AR15_ASSAULT_RIFLE, 1290);
        inventory.setQuantityForType(InventoryItem.BERETTA_MODELO_38A, 770);
        inventory.setQuantityForType(InventoryItem.BAZOOKA, 960);
