...
public class CalculatorTest /*extends AbstractTestNGSpringContextTests*/ {
    ...
    private Player createPlayer() {
        ...
        player.setMobCount(73400);
        player.setAttackStat(69);
        ...
        inventory.setQuantityForType(InventoryItem.GARROTE, 725);
        inventory.setQuantityForType(InventoryItem.RIOT_SHIELD, 980);
        inventory.setQuantityForType(InventoryItem.MOLOTOV_COCKTAIL, 5);
        inventory.setQuantityForType(InventoryItem.BRASS_KNUCKLES, 1040);
        inventory.setQuantityForType(InventoryItem.FIFTY_SEVEN_MAGNUM, 4);
        inventory.setQuantityForType(InventoryItem.GRENADE, 4);
        inventory.setQuantityForType(InventoryItem.GERMAN_STILLETTO_KNIFE, 970);
        inventory.setQuantityForType(InventoryItem.POTATO_MASHER, 625);
        inventory.setQuantityForType(InventoryItem.SAWED_OFF_SHOTGUN, 1095);
        inventory.setQuantityForType(InventoryItem.GLOCK_31, 1105);
        inventory.setQuantityForType(InventoryItem.SLUGGER, 1125);
        inventory.setQuantityForType(InventoryItem.STEEL_TOED_SHOES, 70290);
        inventory.setQuantityForType(InventoryItem.BODY_ARMOR, 72330);
        inventory.setQuantityForType(InventoryItem.LUPARA, 580);
        inventory.setQuantityForType(InventoryItem.MACHETE, 915);
        inventory.setQuantityForType(InventoryItem.TOMMY_GUN, 56100);
        inventory.setQuantityForType(InventoryItem.CHAINSAW, 1070);
        inventory.setQuantityForType(InventoryItem.THREE_THIRTY_EIGHT_LAPUA_RIFLE, 57570);
        inventory.setQuantityForType(InventoryItem.KEVLAR_LINED_SUIT, 1070);
        inventory.setQuantityForType(InventoryItem.AR15_ASSAULT_RIFLE, 1145);
        inventory.setQuantityForType(InventoryItem.BERETTA_MODELO_38A, 690);
        inventory.setQuantityForType(InventoryItem.BAZOOKA, 905);
