...
public class CalculatorTest /*extends AbstractTestNGSpringContextTests*/ {
    ...
    private Player createPlayer() {
        ...
        inventory.setQuantityForType(InventoryItem.GARROTE, 675);
        inventory.setQuantityForType(InventoryItem.RIOT_SHIELD, 930);
        inventory.setQuantityForType(InventoryItem.BRASS_KNUCKLES, 975);
        ...
        inventory.setQuantityForType(InventoryItem.SAWED_OFF_SHOTGUN, 780);
        inventory.setQuantityForType(InventoryItem.GLOCK_31, 1075);
        inventory.setQuantityForType(InventoryItem.SLUGGER, 705);
        inventory.setQuantityForType(InventoryItem.STEEL_TOED_SHOES, 69910);
        inventory.setQuantityForType(InventoryItem.BODY_ARMOR, 71505);
        inventory.setQuantityForType(InventoryItem.LUPARA, 565);
        inventory.setQuantityForType(InventoryItem.MACHETE, 555);
        inventory.setQuantityForType(InventoryItem.TOMMY_GUN, 40000);
        inventory.setQuantityForType(InventoryItem.CHAINSAW, 1030);
        inventory.setQuantityForType(InventoryItem.THREE_THIRTY_EIGHT_LAPUA_RIFLE, 65400);
