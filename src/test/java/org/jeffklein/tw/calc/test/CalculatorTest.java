...
public class CalculatorTest /*extends AbstractTestNGSpringContextTests*/ {
    ...
    private Player createPlayer() {
        ...
        inventory.setQuantityForType(InventoryItem.GARROTE, 920);
        inventory.setQuantityForType(InventoryItem.RIOT_SHIELD, 1140);
        inventory.setQuantityForType(InventoryItem.MOLOTOV_COCKTAIL, 5);
        inventory.setQuantityForType(InventoryItem.BRASS_KNUCKLES, 1275);
        ...
        inventory.setQuantityForType(InventoryItem.GERMAN_STILLETTO_KNIFE, 1120);
        inventory.setQuantityForType(InventoryItem.POTATO_MASHER, 805);
        inventory.setQuantityForType(InventoryItem.SAWED_OFF_SHOTGUN, 1220);
        inventory.setQuantityForType(InventoryItem.GLOCK_31, 1300);
        inventory.setQuantityForType(InventoryItem.SLUGGER, 1285);
        inventory.setQuantityForType(InventoryItem.STEEL_TOED_SHOES, 79995);
        inventory.setQuantityForType(InventoryItem.BODY_ARMOR, 82390);
        inventory.setQuantityForType(InventoryItem.LUPARA, 795);
        inventory.setQuantityForType(InventoryItem.MACHETE, 1085);
        inventory.setQuantityForType(InventoryItem.TOMMY_GUN, 62425);
        inventory.setQuantityForType(InventoryItem.CHAINSAW, 1235);
        inventory.setQuantityForType(InventoryItem.THREE_THIRTY_EIGHT_LAPUA_RIFLE, 64275);
        inventory.setQuantityForType(InventoryItem.KEVLAR_LINED_SUIT, 1210);
        inventory.setQuantityForType(InventoryItem.AR15_ASSAULT_RIFLE, 1495);
        inventory.setQuantityForType(InventoryItem.BERETTA_MODELO_38A, 910);
        inventory.setQuantityForType(InventoryItem.BAZOOKA, 1150);
