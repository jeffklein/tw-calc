...
//        inventory.setQuantityForType(InventoryItem.GARROTE, 815);
        inventory.setQuantityForType(InventoryItem.RIOT_SHIELD, 1035);
//        inventory.setQuantityForType(InventoryItem.MOLOTOV_COCKTAIL, 5);
//        inventory.setQuantityForType(InventoryItem.BRASS_KNUCKLES, 1130);
//        inventory.setQuantityForType(InventoryItem.FIFTY_SEVEN_MAGNUM, 4);
//        inventory.setQuantityForType(InventoryItem.GRENADE, 4);
        inventory.setQuantityForType(InventoryItem.GERMAN_STILLETTO_KNIFE, 1000);
//        inventory.setQuantityForType(InventoryItem.POTATO_MASHER, 695);
//        inventory.setQuantityForType(InventoryItem.SAWED_OFF_SHOTGUN, 1110);
//        inventory.setQuantityForType(InventoryItem.GLOCK_31, 1195);
        inventory.setQuantityForType(InventoryItem.SLUGGER, 1165);
        inventory.setQuantityForType(InventoryItem.STEEL_TOED_SHOES, 74210);
        inventory.setQuantityForType(InventoryItem.BODY_ARMOR, 76375);
        inventory.setQuantityForType(InventoryItem.LUPARA, 665);
        inventory.setQuantityForType(InventoryItem.MACHETE, 970);
        inventory.setQuantityForType(InventoryItem.TOMMY_GUN, 60090);
        inventory.setQuantityForType(InventoryItem.CHAINSAW, 1155);
        inventory.setQuantityForType(InventoryItem.THREE_THIRTY_EIGHT_LAPUA_RIFLE, 61545);
        inventory.setQuantityForType(InventoryItem.KEVLAR_LINED_SUIT, 1125);
        inventory.setQuantityForType(InventoryItem.AR15_ASSAULT_RIFLE, 1190);
        inventory.setQuantityForType(InventoryItem.BERETTA_MODELO_38A, 730);
        inventory.setQuantityForType(InventoryItem.BAZOOKA, 930);
