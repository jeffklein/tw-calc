...
public class CalculatorTest /*extends AbstractTestNGSpringContextTests*/ {
    ...
    private Player createPlayer() {
        ...
        inventory.setQuantityForType(InventoryItem.RIOT_SHIELD, 1315);
        inventory.setQuantityForType(InventoryItem.MOLOTOV_COCKTAIL, 5);
        inventory.setQuantityForType(InventoryItem.BRASS_KNUCKLES, 1510);
        ...
        inventory.setQuantityForType(InventoryItem.GERMAN_STILLETTO_KNIFE, 1695);
        inventory.setQuantityForType(InventoryItem.POTATO_MASHER, 985);
        inventory.setQuantityForType(InventoryItem.SAWED_OFF_SHOTGUN, 1815);
        inventory.setQuantityForType(InventoryItem.GLOCK_31, 1465);
        inventory.setQuantityForType(InventoryItem.SLUGGER, 2000);
        inventory.setQuantityForType(InventoryItem.STEEL_TOED_SHOES, 86795);
        inventory.setQuantityForType(InventoryItem.BODY_ARMOR, 90055);
        inventory.setQuantityForType(InventoryItem.LUPARA, 1030);
        inventory.setQuantityForType(InventoryItem.MACHETE, 1780);
        inventory.setQuantityForType(InventoryItem.TOMMY_GUN, 51960);
        inventory.setQuantityForType(InventoryItem.CHAINSAW, 1425);
        inventory.setQuantityForType(InventoryItem.THREE_THIRTY_EIGHT_LAPUA_RIFLE, 55390);
        inventory.setQuantityForType(InventoryItem.KEVLAR_LINED_SUIT, 1945);
        inventory.setQuantityForType(InventoryItem.AR15_ASSAULT_RIFLE, 2630);
        inventory.setQuantityForType(InventoryItem.BERETTA_MODELO_38A, 1620);
        inventory.setQuantityForType(InventoryItem.BAZOOKA, 1830);
