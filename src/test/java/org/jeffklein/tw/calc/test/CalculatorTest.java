...
public class CalculatorTest /*extends AbstractTestNGSpringContextTests*/ {
    ...
    private Player createPlayer() {
        ...
        inventory.setQuantityForType(InventoryItem.GERMAN_STILLETTO_KNIFE, 1065);
        inventory.setQuantityForType(InventoryItem.POTATO_MASHER, 780);
        inventory.setQuantityForType(InventoryItem.SAWED_OFF_SHOTGUN, 1125);
        inventory.setQuantityForType(InventoryItem.GLOCK_31, 1255);
        inventory.setQuantityForType(InventoryItem.SLUGGER, 1255);
        inventory.setQuantityForType(InventoryItem.STEEL_TOED_SHOES, 78540);
        inventory.setQuantityForType(InventoryItem.BODY_ARMOR, 80830);
        inventory.setQuantityForType(InventoryItem.LUPARA, 765);
        inventory.setQuantityForType(InventoryItem.MACHETE, 995);
        inventory.setQuantityForType(InventoryItem.TOMMY_GUN, 63290);
        inventory.setQuantityForType(InventoryItem.CHAINSAW, 1210);
        inventory.setQuantityForType(InventoryItem.THREE_THIRTY_EIGHT_LAPUA_RIFLE, 64865);
        inventory.setQuantityForType(InventoryItem.KEVLAR_LINED_SUIT, 1170);
        inventory.setQuantityForType(InventoryItem.AR15_ASSAULT_RIFLE, 1345);
        inventory.setQuantityForType(InventoryItem.BERETTA_MODELO_38A, 800);
        inventory.setQuantityForType(InventoryItem.BAZOOKA, 995);
