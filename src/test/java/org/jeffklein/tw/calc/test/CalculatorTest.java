...
public class CalculatorTest /*extends AbstractTestNGSpringContextTests*/ {
    ...
    private Player createPlayer() {
        ...
        inventory.setQuantityForType(InventoryItem.GARROTE, 835);
        inventory.setQuantityForType(InventoryItem.RIOT_SHIELD, 1055);
        inventory.setQuantityForType(InventoryItem.MOLOTOV_COCKTAIL, 5);
        inventory.setQuantityForType(InventoryItem.BRASS_KNUCKLES, 1170);
        ...
        inventory.setQuantityForType(InventoryItem.GERMAN_STILLETTO_KNIFE, 1040);
        inventory.setQuantityForType(InventoryItem.POTATO_MASHER, 725);
        inventory.setQuantityForType(InventoryItem.SAWED_OFF_SHOTGUN, 1125);
        inventory.setQuantityForType(InventoryItem.GLOCK_31, 1220);
        inventory.setQuantityForType(InventoryItem.SLUGGER, 1230);
        inventory.setQuantityForType(InventoryItem.STEEL_TOED_SHOES, 76115);
        inventory.setQuantityForType(InventoryItem.BODY_ARMOR, 78350);
        inventory.setQuantityForType(InventoryItem.LUPARA, 695);
        inventory.setQuantityForType(InventoryItem.MACHETE, 980);
        inventory.setQuantityForType(InventoryItem.TOMMY_GUN, 60880);
        inventory.setQuantityForType(InventoryItem.CHAINSAW, 1175);
        inventory.setQuantityForType(InventoryItem.THREE_THIRTY_EIGHT_LAPUA_RIFLE, 62460);
        inventory.setQuantityForType(InventoryItem.KEVLAR_LINED_SUIT, 1150);
        inventory.setQuantityForType(InventoryItem.AR15_ASSAULT_RIFLE, 1300);
        inventory.setQuantityForType(InventoryItem.BERETTA_MODELO_38A, 775);
        inventory.setQuantityForType(InventoryItem.BAZOOKA, 975);
