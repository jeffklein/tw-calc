...
public class CalculatorTest /*extends AbstractTestNGSpringContextTests*/ {
    ...
    private Player createPlayer() {
        ...
        player.setMobCount(74100);
        player.setAttackStat(73);
        ...
        inventory.setQuantityForType(InventoryItem.GARROTE, 745);
        inventory.setQuantityForType(InventoryItem.RIOT_SHIELD, 990);
        inventory.setQuantityForType(InventoryItem.MOLOTOV_COCKTAIL, 5);
        inventory.setQuantityForType(InventoryItem.BRASS_KNUCKLES, 1055);
        inventory.setQuantityForType(InventoryItem.FIFTY_SEVEN_MAGNUM, 4);
        inventory.setQuantityForType(InventoryItem.GRENADE, 4);
        inventory.setQuantityForType(InventoryItem.GERMAN_STILLETTO_KNIFE, 985);
        inventory.setQuantityForType(InventoryItem.POTATO_MASHER, 635);
        inventory.setQuantityForType(InventoryItem.SAWED_OFF_SHOTGUN, 1095);
        inventory.setQuantityForType(InventoryItem.GLOCK_31, 1130);
        inventory.setQuantityForType(InventoryItem.SLUGGER, 1135);
        inventory.setQuantityForType(InventoryItem.STEEL_TOED_SHOES, 70960);
        inventory.setQuantityForType(InventoryItem.BODY_ARMOR, 73020);
        inventory.setQuantityForType(InventoryItem.LUPARA, 590);
        inventory.setQuantityForType(InventoryItem.MACHETE, 925);
        inventory.setQuantityForType(InventoryItem.TOMMY_GUN, 56205);
        inventory.setQuantityForType(InventoryItem.CHAINSAW, 1080);
        inventory.setQuantityForType(InventoryItem.THREE_THIRTY_EIGHT_LAPUA_RIFLE, 58260);
        inventory.setQuantityForType(InventoryItem.KEVLAR_LINED_SUIT, 1080);
        ...
        inventory.setQuantityForType(InventoryItem.BAZOOKA, 910);
