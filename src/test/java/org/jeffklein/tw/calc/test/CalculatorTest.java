...
public class CalculatorTest /*extends AbstractTestNGSpringContextTests*/ {
    ...
    private Player createPlayer() {
        ...
        inventory.setQuantityForType(InventoryItem.GARROTE, 925);
        inventory.setQuantityForType(InventoryItem.RIOT_SHIELD, 1160);
        inventory.setQuantityForType(InventoryItem.MOLOTOV_COCKTAIL, 5);
        inventory.setQuantityForType(InventoryItem.BRASS_KNUCKLES, 1310);
        ...
        inventory.setQuantityForType(InventoryItem.POTATO_MASHER, 815);
        inventory.setQuantityForType(InventoryItem.SAWED_OFF_SHOTGUN, 1465);
        inventory.setQuantityForType(InventoryItem.GLOCK_31, 1320);
        inventory.setQuantityForType(InventoryItem.SLUGGER, 1695);
        inventory.setQuantityForType(InventoryItem.STEEL_TOED_SHOES, 80615);
        inventory.setQuantityForType(InventoryItem.BODY_ARMOR, 83350);
        inventory.setQuantityForType(InventoryItem.LUPARA, 840);
        inventory.setQuantityForType(InventoryItem.MACHETE, 1435);
        inventory.setQuantityForType(InventoryItem.TOMMY_GUN, 53570);
        inventory.setQuantityForType(InventoryItem.CHAINSAW, 1255);
        inventory.setQuantityForType(InventoryItem.THREE_THIRTY_EIGHT_LAPUA_RIFLE, 56135);
