...
public class CalculatorTest /*extends AbstractTestNGSpringContextTests*/ {
    ...
    private Player createPlayer() {
        ...
        inventory.setQuantityForType(InventoryItem.RIOT_SHIELD, 1040);
        inventory.setQuantityForType(InventoryItem.MOLOTOV_COCKTAIL, 5);
        inventory.setQuantityForType(InventoryItem.BRASS_KNUCKLES, 1140);
        inventory.setQuantityForType(InventoryItem.FIFTY_SEVEN_MAGNUM, 4);
        inventory.setQuantityForType(InventoryItem.GRENADE, 4);
        inventory.setQuantityForType(InventoryItem.GERMAN_STILLETTO_KNIFE, 1030);
        inventory.setQuantityForType(InventoryItem.POTATO_MASHER, 700);
        inventory.setQuantityForType(InventoryItem.SAWED_OFF_SHOTGUN, 1120);
        inventory.setQuantityForType(InventoryItem.GLOCK_31, 1200);
        inventory.setQuantityForType(InventoryItem.SLUGGER, 1225);
        inventory.setQuantityForType(InventoryItem.STEEL_TOED_SHOES, 74130);
        inventory.setQuantityForType(InventoryItem.BODY_ARMOR, 76355);
        inventory.setQuantityForType(InventoryItem.LUPARA, 665);
        inventory.setQuantityForType(InventoryItem.MACHETE, 980);
        inventory.setQuantityForType(InventoryItem.TOMMY_GUN, 58945);
        inventory.setQuantityForType(InventoryItem.CHAINSAW, 1165);
        inventory.setQuantityForType(InventoryItem.THREE_THIRTY_EIGHT_LAPUA_RIFLE, 60515);
        inventory.setQuantityForType(InventoryItem.KEVLAR_LINED_SUIT, 1145);
        inventory.setQuantityForType(InventoryItem.AR15_ASSAULT_RIFLE, 1280);
        inventory.setQuantityForType(InventoryItem.BERETTA_MODELO_38A, 750);
        inventory.setQuantityForType(InventoryItem.BAZOOKA, 955);
